...
1. **Copia l'URL** dalla pagina anime su AnimeWorld
2. **Incolla** nell'applicazione e clicca "Estrai Link"
3. **Avvia il download** - Il sistema gestisce tutto automaticamente
4. **Monitora il progresso** con la barra di avanzamento in tempo reale
...
[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/S6S41LYUI0)